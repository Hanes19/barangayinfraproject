...
<div class="app-wrapper">
    <aside class="sidebar" id="sidebar">
        ...
        <div class="sidebar-menu">
            ...
            <a href="admin_checking"><i class="fas fa-list-check"></i><span class="nav-text">Checking & Review</span></a>
            <a href="admin_monitoring"><i class="fas fa-hammer"></i><span class="nav-text">Supervision and Monitoring</span></a>
