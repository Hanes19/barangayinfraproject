                    ...
                    <table class="table table-hover mb-0">
                        ...
                        <?php if(mysqli_num_rows($projects_result) > 0): 
                            ...
                            while($project = mysqli_fetch_assoc($projects_result)): 
                                ...
                                $progress = 0;
                                if ($status == 'rejected' || $checking_status == 'declined') {
                                    $progress = 0;
                                } elseif ($status == 'done' || $status == 'completed' || $monitoring_status == 'completed') {
                                    $progress = 100;
                                } elseif ($monitoring_status == 'inspection_requested' || $status == 'ongoing') {
                                    $progress = 60;
                                } elseif ($checking_status == 'approved' || $ceo_status == 'approved') {
                                    $progress = 30;
                                } else {
                                    $progress = 10;
                                }
                        ?>
                            <tr>
                                ...
                                <td data-label="Status">
                                    ...
                                    <?php 
                                    // Check if CEO has approved it, so they can request inspection
                                    $is_fully_approved = ($ceo_status == 'approved' || $checking_status == 'approved');
                                    
                                    if ($is_fully_approved && $monitoring_status != 'inspection_requested' && $monitoring_status != 'completed'): ?>
                                ...
                                <td data-label="Actions">
                                    <div class="d-flex flex-wrap gap-1">
                                        ...
                                        <?php if ($is_fully_approved && $monitoring_status != 'inspection_requested' && $monitoring_status != 'completed'): ?>
